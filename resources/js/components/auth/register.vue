                ...
                <div class="login-form">
                  ...
                  <form class="user" @submit.prevent="signUp">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputFirstName" v-model="form.name" placeholder="Enter First Name">
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" class="form-control" id="exampleInputPasswordRepeat"
                        v-model="form.password_confirmation" placeholder="Repeat Password">
